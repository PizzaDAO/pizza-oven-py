...
Copy the .env.example file and rename it .env. You must fill in the ETHEREUM_RINKEBY_SOCKET_SERVER with a Rinkeby websocket from [Alchemy.com](http://alchemy.com).
